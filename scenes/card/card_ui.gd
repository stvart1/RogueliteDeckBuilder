...
func play() -> void:
	...
	#var tree := get_tree()
	var temp = get_tree().get_first_node_in_group("ui_layer")
	temp.hand.resize_hand()
...
func request_tooltip() -> void:
	...
	Events.tooltip_requested.emit(card.art, card.title, updated_tooltip)
...
func _set_char_stats(value: CharacterStats) -> void:
	char_stats = value
	Events.stats_changed.connect(_on_char_stats_changed)
